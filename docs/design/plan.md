...
장기기억(사실 추출→벡터 검색), 사실 충돌·망각 규칙, 친밀도 산식(D9 — 계수는 페르소나가 소유하는 **성격 역학 파라미터**: 같은 말에도 캐릭터마다 다르게 영향받음)·페르소나 전환(히스테리시스 포함).
...
| 6 | **Phase 4** — 장기기억(D6 sqlite-vec) · 사실 충돌·망각 · D9 친밀도 산식 · 페르소나 전환 히스테리시스 | — | **대** |
